...
import PersonList from "../components/PersonList"; // Ajusta la ruta si es diferente
...
export default function Home() {
  ...
  const handleAssign = () => {
    ...
    setTimeout(() => {
      ...
      result.forEach((a) =>
        console.log(`${a.giver} → ${a.receiver} (token: ${a.token})`)
      );
    }, 2000);
  };
                ...
                <tr key={idx}>
                  ...
                  <td>
                    <button
                      ...
                      onClick={() => {
                        const url = `${window.location.origin}/#/consulta?token=${a.token}`;
